...
var file_status_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x52, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x1d, 0x0a, 0x07, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x32, 0x3d, 0x0a, 0x0d, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2c, 0x0a, 0x07, 0x43,
	0x68, 0x65, 0x63, 0x6b, 0x49, 0x6e, 0x12, 0x0e, 0x2e, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a, 0x0f, 0x2e, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e,
...
var file_status_proto_goTypes = []interface{}{
	...
	(*Message)(nil),             // 1: status.Message
	(*timestamp.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_status_proto_depIdxs = []int32{
	2, // 0: status.Status.timestamp:type_name -> google.protobuf.Timestamp
	0, // 1: status.StatusService.CheckIn:input_type -> status.Status
	1, // 2: status.StatusService.CheckIn:output_type -> status.Message
...
func (c *statusServiceClient) CheckIn(ctx context.Context, in *Status, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/status.StatusService/CheckIn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StatusService_CheckIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/status.StatusService/CheckIn",
	}
