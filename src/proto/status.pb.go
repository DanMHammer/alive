...
func (x *Status) GetLatest() *timestamp.Timestamp {
	if x != nil {
		return x.Latest
	}
	return nil
...
func (x *Status) GetStarted() *timestamp.Timestamp {
	if x != nil {
		return x.Started
	}
	return nil
...
var file_status_proto_rawDesc = []byte{
	...
	,
...
var file_status_proto_depIdxs = []int32{
	2, // 0: proto.Status.latest:type_name -> google.protobuf.Timestamp
	2, // 1: proto.Status.started:type_name -> google.protobuf.Timestamp
	0, // 2: proto.StatusService.CheckIn:input_type -> proto.Status
	1, // 3: proto.StatusService.CheckIn:output_type -> proto.Message
...
type StatusServiceClient interface {
	CheckIn(ctx context.Context, in *Status, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *statusServiceClient) CheckIn(ctx context.Context, in *Status, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/proto.StatusService/CheckIn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatusServiceServer interface {
	CheckIn(context.Context, *Status) (*Message, error)
}
...
func (*UnimplementedStatusServiceServer) CheckIn(context.Context, *Status) (*Message, error) {
...
func _StatusService_CheckIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Status)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatusServiceServer).CheckIn(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.StatusService/CheckIn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServiceServer).CheckIn(ctx, req.(*Status))
	}
...
var _StatusService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CheckIn",
			Handler:    _StatusService_CheckIn_Handler,
		},
	},
